...
<body>
	...
	if (request.getAttribute("message") != null) {
		...
		out.print("NO 컬럼 값이 " + request.getAttribute("sendvalue") + "가 아닙니다. 올바르게 입력해주세요.");
	}
	%>
	<%@ include file="header.jsp"%>
	<div class="section" style="min-height: 400px">
		<h2 align="left">후보등록</h2>
		<form name="form" action="register_join_ok.jsp" method="post">
			<table border="1" width="600">
				<tr>
					<td align="left" width="40%">후보번호</td>
					<td align="left" width="60%"><input type="text" name="NO"
						size="10" maxlength="2"></td>
				</tr>

				<tr>
					<td align="left" width="40%">이름</td>
					<td align="left" width="60%"><input type="text" name="Name"
						size="10" maxlength="20"></td>
				</tr>

				<tr>
					<td align="left" width="40%">반</td>
					<td align="left" width="60%"><select name="Code">
				...
				<tr>
					<td align="left" width="40%">학력</td>
					<td align="left" width="60%"><select name="School">
				...
				<tr>
					<td align="left" width="40%">주민번호</td>
					<td align="left" width="60%"><input type="text" name="jumin"
						size="6" maxlength="6"> - <input type="text" name="jumin2"
						size="7" maxlength="7"></td>
				</tr>

				<tr>
					<td align="left" width="40%">전공학년반</td>
					<td align="left" width="60%"><input type="text" name="Major"
